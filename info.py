...
BOT_TOKEN = environ.get('BOT_TOKEN', "8097788870:AAF_Akaun85R--9G6ZeSHE-27YVyVC1pJfA
")
#---------------------------------------------------------------
#---------------------------------------------------------------
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', ' -1002422546963'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/cinema_house_21')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002437244962').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
